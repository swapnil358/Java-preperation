 ...
 * String t is generated by random shuffling string s and then add more letter at a random position. t.length > s.length.
 * Return the letters that was added to t.
 */
public class PrintNewlyAddedLetterToString {
